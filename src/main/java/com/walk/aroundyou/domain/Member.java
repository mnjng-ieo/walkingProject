...
//    public static User createUser(String userId, String userPwd, PasswordEncoder passwordEncoder, String userName, String userNickname, String userTelNumber, String userEmail, String userImg, String userDescription, Timestamp userJoinDate, Timestamp userUpdateDate, UserRole role, StateId stateId, boolean socialYn) {
//        return new User(userId, passwordEncoder.encode(userPwd), userName, userNickname, userTelNumber, userEmail, userImg, userDescription, userJoinDate, userUpdateDate, "USER", "NORMAL", false);
//    }
...
//    }
//
//    public void setUnencodedPassword(String unencodedPwd) {
//        this.unencodedPwd = unencodedPwd;
//    }
	...
	public User(String userId2, String encode, String userName2, String userNickname2, String userTelNumber2,
			String userEmail2, String userImg2, String userDescription2, Timestamp userJoinDate2,
			Timestamp userUpdateDate2, String string, String string2, boolean b) {
