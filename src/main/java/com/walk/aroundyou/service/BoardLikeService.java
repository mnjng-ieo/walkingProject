...
public class BoardLikeService {
	...
	// 마이페이지에서 좋아요한 게시물 조회
	public List<Long> findLikedBoardByUser(Member user) {
		
        return boardLikeRepository.findLikedBoardIdByUserId(user);
    }

	
	// 사용자가 게시물 좋아요 표시 클릭 시 선택 + 해제
	public boolean toggleLike(Member user, Board board) {
