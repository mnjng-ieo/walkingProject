...
public class UserService {
	...
	public String updateMemberPassword(UserPasswordChangeDTO dto, String userId) {
        ...
        Member member = userRepository.findByUserId(userId).orElseThrow(() -> new UsernameNotFoundException("아이디가 존재하지 않습니다."));
	...
	public void updatePwd(String tmpPwd, String userEmail) {
		...
		Member member = userRepository.findByUserEmail(userEmail).orElseThrow(()-> new IllegalArgumentException("해당 사용자가 존재하지 않습니다."));
